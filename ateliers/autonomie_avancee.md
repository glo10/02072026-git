...
- Ensuite en local, effectuez la commande `git remote add origin [URL_GITHUB_DEPOT_DISTANT]`, en remplaçant *[URL_GITHUB_DEPOT_DISTANT]* par votre URL par exemple par *https://github.com/glo10/02072026_git*
