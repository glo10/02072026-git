...
- [x] Naviguer entre les différentes branches
- [x] Fusionner les branches sans conflits
- [x] Fusionner des branches en résolvant des conflits
- [x] Récupérer les modifications distants sans impacter son espace physique (working directory)
